...
const WeatherGet = () => {
    ...
    const api = '5ace9901c6764581b8d55636242210'
    // 😀

    const getWeather = async () => {
        try {
            const response = await axios.get(`http://api.weatherapi.com/v1/current.json?key=5ace9901c6764581b8d55636242210&q=${api}&q=${city}&aqi=no`)
